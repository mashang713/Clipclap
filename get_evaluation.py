...
def get_evaluation(args):
    ...
    model_params = get_model_params(
        ...
        getattr(config, "teacher_use_snn_gate", False),
        getattr(config, "teacher_gate_mode", "none"),
        getattr(config, "teacher_sparsity_mode", "none"),
        getattr(config, "teacher_sparse_lambda", 0.0),
        ...
        getattr(config, "teacher_sigmoid_centered", True),
        ...
        getattr(config, "teacher_freeze_text_branch", False),
