...
def main(args):
    ...
    model_params = get_model_params(
        ...
        getattr(args, "teacher_use_snn_gate", False),
        getattr(args, "teacher_gate_mode", "none"),
        getattr(args, "teacher_sparsity_mode", "none"),
        getattr(args, "teacher_sparse_lambda", 0.0),
        ...
        getattr(args, "teacher_snn_arch", "backend_only"),
        getattr(args, "teacher_frontend_snn_timesteps", 4),
        getattr(args, "teacher_frontend_snn_hidden_dim", 512),
        getattr(args, "teacher_frontend_snn_decay", 0.9),
        getattr(args, "teacher_frontend_snn_threshold", 1.0),
        ...
        getattr(args, "teacher_snn_sigmoid_ann_use_audio", True),
